        ...
        var body: some View {
            VStack {
                if self.showEntry == true {
                    VStack {
                        List (Q3equipment.filter({serial.isEmpty ? true : $0.SerialNo!.contains(serial.uppercased()) })) {q3equip in
...
/*
struct serialResults_Previews: PreviewProvider {
